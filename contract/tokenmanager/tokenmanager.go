...
func (_Tokenmanager *TokenmanagerCaller) MAXIMUMBEP2ESYMBOLLEN(opts *bind.CallOpts) (uint8, error) {
	var (
		ret0 = new(uint8)
	)
	out := ret0
	err := _Tokenmanager.contract.Call(opts, out, "MAXIMUM_BEP2E_SYMBOL_LEN")
	return *ret0, err
}
...
//
// Solidity: function MAXIMUM_BEP2E_SYMBOL_LEN() constant returns(uint8)
func (_Tokenmanager *TokenmanagerSession) MAXIMUMBEP2ESYMBOLLEN() (uint8, error) {
	return _Tokenmanager.Contract.MAXIMUMBEP2ESYMBOLLEN(&_Tokenmanager.CallOpts)
}

// MAXIMUMBEP2ESYMBOLLEN is a free data retrieval call binding the contract method 0x077b8f35.
//
// Solidity: function MAXIMUM_BEP2E_SYMBOL_LEN() constant returns(uint8)
func (_Tokenmanager *TokenmanagerCallerSession) MAXIMUMBEP2ESYMBOLLEN() (uint8, error) {
	return _Tokenmanager.Contract.MAXIMUMBEP2ESYMBOLLEN(&_Tokenmanager.CallOpts)
}
...
func (_Tokenmanager *TokenmanagerCaller) MINIMUMBEP2ESYMBOLLEN(opts *bind.CallOpts) (uint8, error) {
	var (
		ret0 = new(uint8)
	)
	out := ret0
	err := _Tokenmanager.contract.Call(opts, out, "MINIMUM_BEP2E_SYMBOL_LEN")
	return *ret0, err
}
...
//
// Solidity: function MINIMUM_BEP2E_SYMBOL_LEN() constant returns(uint8)
func (_Tokenmanager *TokenmanagerSession) MINIMUMBEP2ESYMBOLLEN() (uint8, error) {
	return _Tokenmanager.Contract.MINIMUMBEP2ESYMBOLLEN(&_Tokenmanager.CallOpts)
}

// MINIMUMBEP2ESYMBOLLEN is a free data retrieval call binding the contract method 0xdc6f5e90.
//
// Solidity: function MINIMUM_BEP2E_SYMBOL_LEN() constant returns(uint8)
func (_Tokenmanager *TokenmanagerCallerSession) MINIMUMBEP2ESYMBOLLEN() (uint8, error) {
	return _Tokenmanager.Contract.MINIMUMBEP2ESYMBOLLEN(&_Tokenmanager.CallOpts)
}
...
//
// Solidity: function bindPackageRecord(bytes32 ) constant returns(uint8 packageType, bytes32 bep2TokenSymbol, address contractAddr, uint256 totalSupply, uint256 peggyAmount, uint8 bep2eDecimals, uint64 expireTime)
